...
class PluginConfig(object):
    ...
    def __init__(self, credentials_path=None, access_key=None, secret_key=None, region=None, host=None, proxy_server_name=None, proxy_server_port=None, enable_high_definition_metrics=False, flush_interval_in_seconds=None):
